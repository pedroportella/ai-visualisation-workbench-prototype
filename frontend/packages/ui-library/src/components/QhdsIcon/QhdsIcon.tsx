import qldHealthIconsUrl from "@aivis/ui-assets/icons/qld-health-icons-url";
import qldIconsUrl from "@aivis/ui-assets/icons/qld-icons-url";
import svgIconsUrl from "@aivis/ui-assets/icons/svg-icons-url";
