...
export const qhdsIconSprites = {
  qld: {
    ...
    packageExport: "@aivis/ui-assets/icons/qld-icons-url"
  },
  qldHealth: {
    extendedPrefix: "extended_",
    fileName: "QLD-Health-icons.svg",
    label: "QHDS health icon sprite",
    packageExport: "@aivis/ui-assets/icons/qld-health-icons-url"
  },
  utility: {
    fileName: "svg-icons.svg",
    label: "QHDS utility icon sprite",
    packageExport: "@aivis/ui-assets/icons/svg-icons-url"
  }
} as const;
